...
await fetch('https://imgur/upload', {
method: 'POST',
body: form
})
.then(html => html.json())
.then(post => {
resolve('https://' + post[0].src);
})
...
const banner2 = cfonts.render((`@Vitukjk\nNumero: +55 21 97198-3758\nShadow Bot Domina\n\nCanal: https://www.youtube.com/@zkayser`), {
font: 'console',
align: 'center',
gradient: ['red', 'yellow']
});
 
const banner3 = cfonts.render((`SHADOW|BOT`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'yellow']
});
...
authorname = 'Shadow-Bot'
packname = 'Vitukjk'

const chyt = "5521971983758@s.whatsapp.net";
const nit = "559985570911@s.whatsapp.net";
const supre = "5522997771091@s.whatsapp.net";

const usedCommandRecently = new Set()
const isFiltered = (from) => !!usedCommandRecently.has(from)
const addFilter = (from) => {
usedCommandRecently.add(from)
setTimeout(() => usedCommandRecently.delete(from), 15000)}
